...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 249.0, 500.0, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 590.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 126.0, 711.5, 39.0, 22.0 ],
					"text" : "zl.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 673.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 126.0, 603.5, 55.0, 22.0 ],
					"text" : "zl.slice 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 126.0, 632.5, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 279.5, 26.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 152.5, 43.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 205.5, 500.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.5, 228.0, 32.0, 22.0 ],
					"text" : "Map"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 371.0, 645.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 702.5, 29.5, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.5, 555.0, 160.0, 20.0 ],
					"text" : "device, param, id, min, max"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 555.0, 72.0, 22.0 ],
					"text" : "pack s s i f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 740.5, 56.0, 22.0 ],
					"text" : "s remSig"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 747.0, 55.0, 22.0 ],
					"text" : "s addSig"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.5, 330.0, 30.0, 22.0 ],
					"text" : "id 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 446.5, 355.0, 93.0, 18.753357000000001 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 4.0, 176.5, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 428.5, 312.0, 93.0, 18.753357000000001 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.5, 4.0, 178.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_invisible" : 2,
...
,
					"patching_rect" : [ 410.5, 258.0, 55.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 239.0, 623.0, 53.0, 66.0 ],
...
,
					"patching_rect" : [ 82.5, 259.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Arial Bold",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 382.0, 43.0, 30.0, 22.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 382.0, 75.0, 89.0, 22.0 ],
					"text" : "ignoreclick $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "int", "int" ],
					"patching_rect" : [ 345.0, 15.0, 93.0, 22.0 ],
					"text" : "live.thisdevice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 74.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.5, 67.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.5, 153.0, 65.0, 22.0 ],
					"text" : "hidden $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 82.0, 204.0, 32.0, 22.0 ],
									"text" : "print"
								}
...
,
					"patching_rect" : [ 191.5, 340.0, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 140.0, 55.0, 20.0 ],
									"text" : "zl slice 30"
								}
...
,
					"patching_rect" : [ 191.5, 259.0, 54.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Arial Bold",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 265.5, 399.0, 97.0, 20.0 ],
					"text" : "ParameterRetrieve"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 191.5, 190.0, 25.0, 25.0 ],
					"pictures" : [ "close.svg", "close.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 183.0, 4.0, 15.0, 15.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"focusbordercolor" : [ 0.117647058823529, 0.117647058823529, 0.117647058823529, 1.0 ],
					"id" : "obj-14",
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 191.5, 302.746643000000006, 107.0, 19.753356999999994 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.5, 4.0, 178.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 391.5, 291.873320999999976, 201.0, 291.873320999999976 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 391.5, 178.5, 201.0, 178.5 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 201.0, 331.5, 71.5, 331.5, 71.5, 248.0, 92.0, 248.0 ],
					"order" : 1,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 420.0, 291.373320999999976, 201.0, 291.373320999999976 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 333.5, 461.0, 44.0, 461.0, 44.0, 26.0, 162.0, 26.0 ],
					"order" : 1,
					"source" : [ "obj-16", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 92.0, 292.373320999999976, 201.0, 292.373320999999976 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 201.0, 371.0, 175.0, 371.0, 175.0, 292.746643000000006, 201.0, 292.746643000000006 ],
					"source" : [ "obj-42", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "close.svg",
				"bootpath" : "~/Documents/McGill Courses/MUMT-620/finalProject",
				"patcherrelativepath" : ".",
				"type" : "svg",
				"implicit" : 1
			}
, 			{
				"name" : "ParameterRetrieve.maxpat",
				"bootpath" : "~/Documents/McGill Courses/MUMT-620/finalProject",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
